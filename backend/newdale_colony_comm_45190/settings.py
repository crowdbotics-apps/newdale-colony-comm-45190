"""
Django settings for newdale_colony_comm_45190 project.
...
ROOT_URLCONF = 'newdale_colony_comm_45190.urls'
...
WSGI_APPLICATION = 'newdale_colony_comm_45190.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newdale_colony_comm_45190 API",
    "DESCRIPTION": "API documentation for newdale_colony_comm_45190 App",
    "VERSION": "v1",
}
